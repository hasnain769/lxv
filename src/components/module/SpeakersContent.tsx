import { Users, Building, Star, GraduationCap, Linkedin, Globe, Video } from "lucide-react";
...
export function SpeakersContent() {
  return (
    <div className="space-y-8">
      {/* Title */}
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-2">Speakers & Creators</h2>
        <p className="text-muted-foreground">Meet the experts behind this module</p>
      </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-xl font-bold text-foreground">Module Creators</h3>
        </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-xl font-bold text-foreground">Live Session Speakers</h3>
        </div>
        <p className="text-muted-foreground mb-6">
            ...
            <div key={index} className="bg-card border border-border rounded-xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="font-semibold text-foreground text-lg">{speaker.name}</h4>
